...
## Project Structure
    ...
    ├── testapiautostoryboa_56767  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_56767`
...
2. Clone this repo and `cd testapiautostoryboa_56767`
